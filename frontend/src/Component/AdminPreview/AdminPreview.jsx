...
const AdminPreview = () => {
  ...
  useEffect(() => {
    ...
    const fetchAdmin = async () => {
      try {
        const response = await axios.get("https://hostel-management-app.vercel.app/admin");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://hostel-management-app.vercel.app/admin/${id}`);
  ...
  const handleUpdateRole = async (id, newRole) => {
    try {
      const response = await axios.patch(`https://hostel-management-app.vercel.app/admin/${id}`, {
        role: newRole
      });
